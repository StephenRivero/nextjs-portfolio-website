    ...
    <div id='skills' className='w-full pb-16 pt-16 lg:pt-14 2xl:pt-16  p-2 sm:p-5 flex justify-center'>
        <div className='max-w-[1240px] lg:w-[95%] mx-auto flex flex-col justify-center h-full'>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8'>
                ...
                <div className='order-4 h-fit p-[12px] sm:p-6 border border-teal-100 shadow-lg shadow-[#8ac9cf] rounded-xl hover:scale-105 ease-in-out duration-200'>
                    <div className='flex justify-center items-center gap-5'>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <div className='grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8'>
                    <div className='h-fit p-3 sm:p-6 border border-teal-100 shadow-lg shadow-teal-300 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="61" height="61" viewBox="0 0 1000 1000" fill="none">
            ...
            <div className='flex flex-col mt-10'>
                ...
                <div className='grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-8'>
                    <div className='h-fit p-3 sm:p-[23px] shadow-lg border border-orange-100 shadow-orange-500 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <Image 
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-green-100 shadow-lg shadow-[#68A063] rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg className='h-[64px]' xmlns="http://www.w3.org/2000/svg" width="256px" height="289px" viewBox="0 0 256 289" version="1.1" preserveAspectRatio="xMidYMid">
                                <g>
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-red-100 shadow-lg shadow-red-400 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg className='h-[64px] py-[20px]' xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="540px" height="210px" viewBox="0 0 18 7">
