    ...
    <div id='skills' className='w-full pb-16 pt-16 lg:pt-14 2xl:pt-16  p-2 flex justify-center'>
        <div className='max-w-[1240px] lg:w-[95%] mx-auto flex flex-col justify-center h-full'>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8'>
                ...
                <div className='order-4 h-fit p-[12px] sm:p-6 border border-teal-100 shadow-lg sm:shadow-xl shadow-[#8ac9cf] rounded-xl hover:scale-105 ease-in-out duration-200'>
                    <div className='flex justify-center items-center gap-5'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.116 22.806" width="62" height="62"><g opacity=".8"><path d="M33.71 0L11.207 22.693l.113.113h22.586l11.21-11.304z" fill="#d8dee9"/><path d="M11.405 0l22.578 22.769-.039.037H11.209L0 11.502z" fill="#8ac0cf"/></g></svg>
                        <div className='hidden sm:flex items-center justify-center'>
                            <h3>
                                AlpineJs
                            </h3>
                ...
                <div className='hidden order-4 h-fit p-[12px] sm:p-6 border border-blue-100 shadow-lg sm:shadow-xl shadow-blue-400 rounded-xl hover:scale-105 ease-in-out duration-200'>
                    <div className='flex justify-center items-center gap-5'>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <div className='grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8'>
                    <div className='h-fit p-3 sm:p-6 border border-teal-100 shadow-lg shadow-teal-300 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <Image 
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-blue-100 shadow-lg shadow-blue-300 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 476.30000000000007" width="60" height="60" alt="Material UI logo"><path d="M0 259.8V0l225 129.9v86.6L75 129.9v173.2z" fill="#00b0ff"/><path d="M225 129.9L450 0v259.8l-150 86.6-75-43.3 150-86.6v-86.6l-150 86.6z" fill="#0081cb"/><path d="M225 303.1v86.6l150 86.6v-86.6z" fill="#00b0ff"/><path d="M375 476.3l225-129.9V173.2l-75 43.3v86.6l-150 86.6zm150-346.4V43.3L600 0v86.6z" fill="#0081cb"/>
                            </svg>
                            <div className='hidden sm:flex items-center justify-center'>
                                <h3>
                                    Material UI
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-black/10 shadow-lg shadow-black/50 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg xmlns="http:www.w3.org/2000/svg" viewBox="0 0 14 21" role="presentation" width="60" height="60" alt="Framer Motion logo"><path d="M0 0h14v7H7zm0 7h7l7 7H7v7l-7-7z" fill="currentColor"></path>
                            </svg>
                            <div className='hidden sm:flex items-center justify-center'>
                                <h3>
                                    Framer Motion
            ...
            <div className='flex flex-col mt-10'>
                ...
                <div className='grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    <div className='h-fit p-3 sm:p-6 shadow-lg border border-orange-100 shadow-orange-500 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <Image 
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-blue-100 shadow-lg shadow-blue-500 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" alt="Bitbucket logo" viewBox="0 0 62.42 62.42">
                                <defs>
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-green-100 shadow-lg shadow-[#68A063] rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg className='h-fit' xmlns="http://www.w3.org/2000/svg" width="256px" height="289px" viewBox="0 0 256 289" version="1.1" preserveAspectRatio="xMidYMid">
                                <g>
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-red-100 shadow-lg shadow-red-400 rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <svg className='h-fit py-[20px]' xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="540px" height="210px" viewBox="0 0 18 7">
                    ...
                    <div className='h-fit p-3 sm:p-6 border border-red-100 shadow-lg shadow-[#FF3B00] rounded-xl hover:scale-105 ease-in-out duration-200'>
                        <div className='flex justify-center items-center gap-5'>
                            <Image 
