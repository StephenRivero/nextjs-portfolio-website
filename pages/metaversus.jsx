...
const youtubeCloneProject = () => {
  return (
    <div className='w-full overflow-x-hidden mx-auto'>
        <div className='w-screen h-[60vw] lg:h-[25vw] relative'>
          <div className='absolute top-0 left-0 w-full h-[60vw] lg:h-[25vw] bg-black/80 z-10' />
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={metaversusImg} alt="/" />
          <div className='absolute top-[75%] sm:top-[88%] lg:top-[85%] xl:top-[88%] max-w-[1240px] pl-4 w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 px-2'>
            <h2 className='pb-2'>
              Metaversus
            </h2>
            <h3>
              Tailwind Css / Framer Motion / ReactJs / NextJs-13
            </h3>
          </div>
        </div>
        <div className='max-w-[1240px] mx-auto grid justify-items-center md:grid-cols-5 md:gap-4 p-2 pl-4 pt-8 md:pr-6'>
          ...
          <div className='col-span-4 md:col-span-1 shadow-xl shadow-red-400 rounded-xl  p-1 mt-8 mr-2 md:mt-0 md:mx-3'>
            <div className='p-4'>
